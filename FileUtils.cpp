...
bool writeBinaryFile(const std::string& filename, const std::vector<unsigned char>& buffer) {
...
std::string makeDefaultOutputName(const std::string& input, const std::string& extension) { return input + extension; }
